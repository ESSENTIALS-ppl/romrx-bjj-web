...
const STEPS: Step[] = [
  ...
  // ── FLOOR CLUSTER ──────────────────────────────────────────────────────────
  {
    ...
    position: [
      ...
      'Hold your phone flat on TOP of your thigh, midway between your hip and your knee. Screen faces the ceiling. Keep one hand on the phone the whole time.',
      'Tap to zero with your leg flat on the ground.',
    ],
    howTo: [
      'Use your free hand to guide your knee toward your chest. The phone hand keeps the phone flat on your thigh as it rises.',
      'Stop when your low back peels off the floor or your opposite leg lifts. Read the number.',
      'Record it. Lower the leg slowly. Re-zero. Repeat on the other side.',
    ],
    mistake: 'Your low back peeling off the floor before you reach your true end range.',
    mistakeFix: 'Keep your opposite leg pressed flat on the ground. The moment your low back lifts - that is your real endpoint, not how far you pulled the knee.',
    fields: [
  ...
  // ── STANDING CLUSTER ───────────────────────────────────────────────────────
  {
    ...
    position: [
      'Stand upright next to a wall. Place one hand on the wall for balance.',
      'Hold your phone flat against the OUTSIDE of your thigh (the surface facing away from your other leg) with your free hand. Screen faces the wall beside you.',
      'Tap to zero while standing straight, weight even on both feet.',
    ],
    howTo: [
      'Lift your test leg SIDEWAYS - out away from your body. Keep your toes pointing forward, not up at the ceiling.',
      'Stop the moment your hip hikes up or your body starts to lean. Read the number.',
      'Record it. Lower the leg. Re-zero. Repeat on the other side.',
    ],
    mistake: 'Your hip hiking up or your whole body tilting sideways to get the leg higher.',
    mistakeFix: 'Keep both hips level the whole time. The moment you feel your standing-side hip drop or your body lean - stop right there. That is your real number.',
    fields: [
