...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    position: [
      ...
      'Let your forearm hang straight DOWN. This is your starting position.',
      'Hold your phone in that hand, screen facing toward you.',
      'Tap to zero with your forearm hanging straight down.',
    ],
    howTo: [
      'Slowly raise your forearm upward toward the ceiling. Keep your upper arm still and elbow at shoulder height.',
      'Stop at the end of comfortable range. Read the number on the screen - or have a partner read it.',
      'Record the number. Return to the starting position. Re-zero. Repeat on the other side.',
    ],
